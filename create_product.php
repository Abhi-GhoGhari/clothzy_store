...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO products (name, description, price, image_url, is_trending) VALUES (?, ?, ?, ?, ?)";
    $stmt = $pdo->prepare($sql);
    $stmt->execute([$name, $desc, $price, $img, $trending]);
...
<head>
    <meta charset="UTF-8">
    <title>Create New Product - Clothzy Admin</title>
...
<body>
    ...
    <main class="container">
        <form action="create_product.php" method="POST" class="product-form" autocomplete="off">
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td><input type="text" id="image_url" name="image_url" placeholder="http://example.com/image.jpg"></td>
                </tr>
                <tr>
                    <td><label for="is_trending">Is Trending?</label></td>
                    <td><input type="checkbox" id="is_trending" name="is_trending" value="1"></td>
                </tr>
                <tr>
                    <td></td>
